            ...
            <div class="content">
                <div class="rating-select" v-if="ratings.tab">
                    ...
                    <span class="item" :class="{'active':selectType==2}" @click="selectTypeFn(2)">
                        <img v-show="selectType != 2" src="./img/icon_normal.png" />
                        <img v-show="selectType == 2" src="./img/icon_highlighted.png" /> {{ratings.tab[2].comment_score_title}}
                    </span>
                </div>
                ...
                <ul class="rating-list">
                    <li v-for="(comment,index) in selectComments" :key="index" class="comment-item">
                        <div class="comment-header">
                            <img :src="comment.user_pic_url" v-show="comment.user_pic_url" />
                            <img src="./img/anonymity.png" v-show="!comment.user_pic_url" />
                        </div>
